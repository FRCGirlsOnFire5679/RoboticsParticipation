    ...
    <form>
      ...
      <section class="form-inputs-container">
        <div class="input-container">
            <label for="covid-19-waiver-participant-name">Participant Name (required)</label>
            <input type="text" v-model.trim="participantNameVaccinated"
                    required
                    onclick="vaccinated"
                    id="covid-19-waiver-participant-name"
                    name="main-waiver-participant-name" />
        </div>
        <br><br>
        <div class="input-container">
            <label for="covid-19-waiver-date">Date </label>
            <input type="text" v-model.trim="vaccinatedDate"
                    id="covid-19-waiver-date"
                    name="covid-19-waiver-date" />
        </div>
